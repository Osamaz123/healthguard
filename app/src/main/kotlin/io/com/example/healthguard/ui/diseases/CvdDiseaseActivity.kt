...
import io.com.example.healthguard.databinding.ActivityCvdDiseaseBinding
import io.com.example.healthguard.ml.HeartDiseaseModel
...
class CvdDiseaseActivity : AppCompatActivity() {
    ...
    private fun showResultDialog(result: String) {
        val dialogView = layoutInflater.inflate(R.layout.cvd_result_dialog, null)

        // Find views
        val textResultMessage = dialogView.findViewById<TextView>(R.id.text_result_message)
        val buttonOk = dialogView.findViewById<Button>(R.id.button_ok)
        val progressBar = dialogView.findViewById<ProgressBar>(R.id.progressBar)

        // Set the result message (initially empty)
        textResultMessage.text = ""
        ...
        // Simulate delay for loading result (replace with your actual inference logic)
        Handler().postDelayed({
            // Update result message and hide progress bar
            val result = performInference()
            textResultMessage.text = result
